...
export default function Loading() {
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-background">
      <div className="relative flex items-center justify-center overflow-hidden w-64 h-20">
        ...
        {/* Text slides in from left and fades out */}
        <span
          className="font-headline text-5xl font-bold text-foreground absolute left-1/2 -translate-x-1/2 animate-slide-and-fade"
        >
          Lodger
        </span>
      </div>
