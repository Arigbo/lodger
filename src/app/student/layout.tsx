...
export default function StudentLayout({
  ...
  const getPageTitle = (path: string) => {
    if (path.includes('/student/properties')) return 'Browse Properties';
    if (path.includes('/student/leases')) return 'My Leases';
    if (path.includes('/student/requests')) return 'My Applications';
    if (path.includes('/student/messages')) return 'Messages';
    if (path.includes('/student/account')) return 'Account Settings';
    if (path.includes('/student/tenancy')) return 'My Tenancy';
    return 'Dashboard';
  };
