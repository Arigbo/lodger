        ...
        >
            ...
            <div className="space-y-2">
                ...
                <p className="text-[10px] md:text-xs font-bold text-muted-foreground/60 uppercase tracking-widest leading-relaxed">
                    Set the foundation of your property listing with essential details and pricing.
                </p>
            </div>
            ...
            <div className="space-y-8">
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Property Brand Name</FormLabel>
                            <FormControl>
                                <Input 
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Asset Configuration</FormLabel>
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                ...
                                <SelectContent className="rounded-2xl border-2 font-black text-[10px] uppercase shadow-2xl">
                                    {PROPERTY_TYPES.map((type) => (
                                        <SelectItem key={type.value} value={type.value} className="group py-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 p-6 md:p-8 rounded-[2.5rem] bg-foreground/[0.02] border border-foreground/[0.03]">
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Monthly ROI (Rent)</FormLabel>
                            <FormControl>
                                <div className="relative group">
                                    ...
                                    />
                                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-primary/40 font-black text-lg">$</span>
                                </div>
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Accounting Unit</FormLabel>
            ...
            <div className="grid grid-cols-2 gap-6 md:gap-10">
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Sleep Areas (Beds)</FormLabel>
                            <FormControl>
                                <Input type="number" placeholder="0" {...field} className="h-14 md:h-16 rounded-2xl bg-foreground/[0.02] border-2 border-transparent focus-visible:border-primary/20 text-sm font-black uppercase tracking-widest" />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Sanitary Units (Baths)</FormLabel>
                            <FormControl>
                                <Input type="number" placeholder="0" {...field} className="h-14 md:h-16 rounded-2xl bg-foreground/[0.02] border-2 border-transparent focus-visible:border-primary/20 text-sm font-black uppercase tracking-widest" />
                            </FormControl>
                            <FormMessage />
