...
import { Sparkles, Utensils, Sofa, Bath, BedDouble, Wifi, Car, AirVent, Dumbbell, Waves, Layout as LayoutIcon } from 'lucide-react';
        ...
        >
            <div className="space-y-2">
                ...
                <p className="text-[10px] md:text-xs font-bold text-muted-foreground/60 uppercase tracking-widest leading-relaxed">
                    Select the premium features that define the living experience of your property.
                </p>
            </div>
                ...
                render={({ field }) => (
                    <FormItem className="space-y-8">
                        <div className="flex items-center justify-between">
                            <FormLabel className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Available Amenities</FormLabel>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className={cn(
                                                ...
                                                isSelected ? "bg-primary text-white" : "bg-muted/10 group-hover:bg-primary/10 group-hover:text-primary"
                                            )}>
                                                <Icon className="h-6 w-6" />
                                            </div>
                                            <span className="text-[10px] font-black uppercase tracking-widest">{amenity}</span>
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        <FormLabel className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">House Protocol (Rules)</FormLabel>
                        <FormControl>
                            <Textarea 
