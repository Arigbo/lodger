...
const formSchema = z
  .object({
    ...
    legalName: z.string().optional(), // Full Legal Name
    firstName: z.string().optional(), // For landlords
    lastName: z.string().optional(), // For landlords
  ...
  .refine(
    (data) => {
      if (data.userType === "student")
        return !!data.legalName && data.legalName.length >= 2;
      return true;
    },
    { message: "Legal Name is required.", path: ["legalName"] },
  )
  .refine(
    (data) => {
...
export default function SignupPage() {
    ...
    userType === "student"
      ? [
          ...
          },
          {
            ...
            fields: ["country", "state", "school", "phone"],
          },
      ...
      : [
          ...
          },
          {
            id: 3,
            name: "Location & Contact",
            fields: ["country", "state", "phone", "whatsappUrl", "twitterUrl"],
          },
          { id: 4, name: "Profile Picture (Optional)", fields: [] },
        ];
  ...
  const nextStep = async () => {
    ...
    const output = await form.trigger(fields as (keyof FormValues)[], {
      shouldFocus: true,
    });
    ...
    try {
      ...
      if (profileImage) {
        try {
          ...
          toast({
            ...
            description:
              "Account created but profile picture upload failed. You can upload it later.",
          });
        }
      }
      ...
      if (error.code === "auth/email-already-in-use") {
        ...
        toast({
          ...
          title: "Access Denied",
          description:
            "Your account was authenticated but we couldn't create your profile due to permission rules. Please contact support.",
        });
      } else {
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-12">
      <Card className="w-full max-w-lg">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Join our community of students and landlords.
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            >
              ...
              >
                {userType === "landlord" && (
                  <>
                    <p className="text-sm text-muted-foreground">
                      Tell us where you're based and how tenants can contact
                      you.
                    </p>
                    <FormField
                      control={form.control}
                ...
                {userType === "student" && (
                  <>
                    <p className="text-sm text-muted-foreground">
                      Help us find properties near your school.
                    </p>
                    <FormField
                      control={form.control}
                      name="country"
              ...
              >
                <div className="text-center space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Help others recognize you! You can skip this step and add it
                    later.
                  </p>
                </div>
