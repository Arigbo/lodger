    ...
    <div className="container mx-auto max-w-4xl py-12 px-4">
      <Card>
        ...
        <CardContent className="prose prose-lg max-w-none space-y-4">
          ...
          <p>
            We use the information we collect to operate, maintain, and provide you with the features and functionality of the RentU service. This includes connecting students with landlords, processing rental requests, and personalizing your experience.
          </p>
          ...
          <p>
            You may, of course, decline to submit personally identifiable information through the Service, in which case RentU may not be able to provide certain services to you. You may update or correct your account information at any time by logging in to your account.
          </p>

           <h2>6. Contact Us</h2>
          <p>
            If you have any questions about this Privacy Policy, please contact us at privacy@rentu.com.
          </p>
        </CardContent>
      </Card>
    </div>
