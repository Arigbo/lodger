...
const users: User[] = [
  ...
  { id: 'user-4', name: 'David Smith', email: 'david@university.edu', avatarUrl: placeholderImages.placeholderImages.find(p => p.id === 'avatar-4')?.imageUrl || '', role: 'landlord', phone: '444-555-6666' },
